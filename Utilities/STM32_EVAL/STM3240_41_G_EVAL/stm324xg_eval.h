...
#define EVAL_COM1_RELAY1_PIN             GPIO_Pin_15
#define EVAL_COM1_RELAY2_PIN             GPIO_Pin_9
#define EVAL_COM1_RELAY3_PIN             GPIO_Pin_10
#define EVAL_COM1_RELAY4_PIN             GPIO_Pin_11
#define EVAL_COM1_RELAY5_PIN             GPIO_Pin_12
#define EVAL_COM1_DE_PIN                 GPIO_Pin_4
#define EVAL_COM1_DE_GPIO_PORT           GPIOA
#define EVAL_COM1_RE_PIN                 GPIO_Pin_5
#define EVAL_COM1_RE_GPIO_PORT           GPIOA
#define COM_RE_HIGH()                    GPIO_SetBits(EVAL_COM1_RE_GPIO_PORT, EVAL_COM1_RE_PIN)
#define COM_RE_LOW()                     GPIO_ResetBits(EVAL_COM1_RE_GPIO_PORT, EVAL_COM1_RE_PIN)
#define COM_DE_HIGH()                    GPIO_SetBits(EVAL_COM1_DE_GPIO_PORT, EVAL_COM1_DE_PIN)
#define COM_DE_LOW()                     GPIO_ResetBits(EVAL_COM1_DE_GPIO_PORT, EVAL_COM1_DE_PIN)
