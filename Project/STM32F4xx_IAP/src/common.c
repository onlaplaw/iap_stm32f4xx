...
void Delay_us(uint16_t wDelay)
{
    if((wDelay >= 10) && (wDelay < 100))
    {
        wDelay += 3;                                       // i+=4 for 150MHz, i+=3 for 180MHz
    }
    else if(wDelay >= 100)
    {
        wDelay += 30;                                      // i+=40 for 150MHz, i+=30 for 180MHz
    }
    for(uint16_t dwIndex = 0; dwIndex < wDelay; dwIndex++)
    {
        for(uint8_t i=0; i<25; i++);                       // i<20 for 150MHz, i<25 for 180MHz
    }
}
